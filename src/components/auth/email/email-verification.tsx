...
const emailVerificationEmailLocalization = {
  ...
  CLICK_BUTTON_TO_VERIFY_EMAIL:
    "Nhấp vào nút bên dưới để xác thực địa chỉ email {emailAddress} cho tài khoản {appName} của bạn.",
  ...
  THIS_LINK_EXPIRES_IN_MINUTES:
    "Liên kết này sẽ hết hạn sau {expirationMinutes} phút.",
  EMAIL_SENT_BY: "Email được gửi bởi {appName}.",
  IF_YOU_DIDNT_REQUEST_THIS_EMAIL:
    "Nếu bạn không yêu cầu email này, bạn có thể an tâm bỏ qua. Có thể ai đó đã nhập nhầm địa chỉ email của bạn.",
